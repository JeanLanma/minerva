        ...
        {{-- Rooms --}}
            <div class="max-w-screen-2xl mx-auto flex flex-wrap justify-center items-center">
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="border-4 border-red-500 h-52 md:h-72 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                        <picture>
                            <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/rooms/simple.jpg') }}" alt="Habitaciones Hotel FCH Minerva">
                        </picture>
                    ...
                    <div class="border-4 border-red-500 p-4 sm:p-6 flex flex-col basis-2/3 xl:h-80 text-center">

                        <h2 class="text-2xl font-bold my-4 sm:my-2 capitalize">18 Habitaciones</h2>

                        <div>

                            <p class="text-sm font-bold text-dark-medium leading-6">
                                ¡Descubre la comodidad en nuestras 18 habitaciones! 🛏️✨ Disfruta de todos los servicios que mereces.
                            </p>
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="p-4 sm:p-6 flex flex-col basis-2/3 xl:h-80 text-center">
                        ...
                        <div>
                            <p class="text-sm font-bold text-dark-medium leading-6">
                                ¡Despierta con sabor! Proximante en nuestro restaurante 😊🍳
                            </p>
                        </div>
